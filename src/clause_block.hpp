...
namespace green_tsetlin
{
    ...
    //         virtual void get_clause_state_sparse(pybind11::array_t<int8_t> out_array, int clause_offset)
    //         {
    //             pybind11::buffer_info buffer_info = out_array.request();                            
    //             std::vector<ssize_t> shape = buffer_info.shape;
    ...
    //         virtual void set_clause_state_sparse(pybind11::array_t<int8_t> in_array, int clause_offset)
    //         {
    //             pybind11::buffer_info buffer_info = in_array.request();                            
    //             std::vector<ssize_t> shape = buffer_info.shape;
