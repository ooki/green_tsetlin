...
def get_inference_cls(f, l, w):
    ...
    n_classes = 2
    n_features = 2
    inference = inference_cls(n_literals, n_clauses, n_classes, n_features)
...
def test_default_empty_class_is_zero_and_getset_works():
    ...
    n_literals, n_clauses, n_classes, n_features, inference = get_inference_cls(False, False, False)
